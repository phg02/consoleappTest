...
public class RentalAgreement {
    ...
    public RentalAgreement(String id,  Owner owner, Host host, Tenant mainTenant, Property property, Period period, Date contract, double rentingFee, Status status) {
        this.owner = owner;
        this.host = host;
        this.id = id;
